const guests = [
  ...
  { id: "12", name: "Ronald & Esposa", passes: 2, table: 20, gender: "mixto" },
  ...
  { id: "75", name: "Gabriel & Monica", passes: 2, table: 15, gender: "mixto" },
  ...
  { id: "92", name: "Dalia", passes: 1, table: 14, gender: "femenino" },
  ...
  { id: "100", name: "Marcela", passes: 1, table: 16, gender: "femenino" },
  { id: "101", name: "Wendy", passes: 1, table: 16, gender: "femenino" },
  { id: "102", name: "Carlos Padilla", passes: 1, table: 16, gender: "masculino" },
  { id: "103", name: "Gabriela", passes: 1, table: 16, gender: "femenino" },
  ...
  { id: "107", name: "Mario & Esposa", passes: 2, table: 17, gender: "mixto" }
];
